import { BookAppoinmentComponent } from './customer/bookAppoinment/book-appoinment/book-appoinment.component';
...
import { EditItemComponent } from './admin/categories/edit-item/edit-item.component';
...
export const routes: Routes = [
  { path: "", redirectTo: "/home", pathMatch: "full" },
  {
    ...
    path: "admin", component: AdminLayoutComponent, canActivate: [userGuard], children: [
      ...
      { path: "editService", component: EditServicesComponent},
    ]
  },
