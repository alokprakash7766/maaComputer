...
import { BookAppoinmentComponent } from './customer/book-appoinment/book-appoinment.component';
import { ServiceAppointmentService } from './services/serviceAppointment/service-appointment.service';
...
export const routes: Routes = [
  { path: "", redirectTo: "/home", pathMatch: "full" },
  {
    path: "", component: CustomerLayoutComponent, children: [
      ...
      { path: "serviceAppointment", component: ServiceAppointmentService  },
