...
ngOnInit() {
  ...
  if (file) {
    // Cloudinary ya Firebase upload code
    this.uploadImageToCloudinary(file).subscribe((imageUrl: string) => {
      this.productForm.get('imageUrl')?.setValue(imageUrl); // ✅ This line is important
    });
  }
}
